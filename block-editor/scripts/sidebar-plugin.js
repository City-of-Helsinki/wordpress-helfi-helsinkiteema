( function( wp ) {
	...
	var { Panel, PanelBody, PanelRow, TextControl, ToggleControl } = wp.components;
	...
	var TextMetaField = metaCompose( textField );
	var ToggleMetaField = metaCompose( toggleField );

	var logoIcon = element('svg',
		{
			height: 24,
			viewBox: '0 0 78 36',
		},
